...
namespace Plugin.NINA.AstroAppHTTPAPI.AstroAppHttpApiDrivers {
    ...
    /// </summary>
    public class AstroAppHttpApiWeatherDriver : BaseINPC, IWeatherData {
        public AstroAppHttpApiWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"AstroAppHttpApi Weather Data ({deviceId})";
        ...
        public string Category => "AstroAppHttpApi Weather Driver";
