...
namespace Plugin.NINA.AstroAppHTTPAPI.AstroAppHttpApiTestCategory {
    ...
    public class AstroAppHttpApiTrigger : SequenceTrigger {
        /// <summary>
        ...
        public AstroAppHttpApiTrigger() {
        }

        public override object Clone() {
            return new AstroAppHttpApiTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AstroAppHttpApiTrigger)}";
        }
    }
}