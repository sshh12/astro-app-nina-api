...
namespace Plugin.NINA.AstroAppHTTPAPI.AstroAppHttpApiTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "Astro App HTTP API")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class AstroAppHttpApiInstruction : SequenceItem {
        /// <summary>
        ...
        public override object Clone() {
            return new AstroAppHttpApiInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AstroAppHttpApiInstruction)}, Text: {Text}";
        }
    }
}