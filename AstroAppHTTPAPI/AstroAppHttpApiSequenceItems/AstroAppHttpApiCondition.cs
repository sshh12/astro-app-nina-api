...
namespace Plugin.NINA.AstroAppHTTPAPI.AstroAppHttpApiTestCategory {
    ...
    public class AstroAppHttpApiCondition : SequenceCondition {
        /// <summary>
        ...
        public AstroAppHttpApiCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new AstroAppHttpApiCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AstroAppHttpApiCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}