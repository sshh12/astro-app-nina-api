...
namespace Plugin.NINA.AstroAppHTTPAPI.AstroAppHttpApiDockables {
    /// <summary>
    ...
    public class AstroAppHttpApiDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public AstroAppHttpApiDockable(
            ...
            dict.Source = new Uri("Plugin.NINA.AstroAppHTTPAPI;component/AstroAppHttpApiDockables/AstroAppHttpApiDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Plugin.NINA.AstroAppHTTPAPI_AltitudeSVG"];
